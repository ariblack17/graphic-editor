...
{
    Init();
    //cout << "graphicviewimp initialized" << endl;
}
...
{
    //cout << "in waitforevent" << endl;
    ALLEGRO_EVENT ev;
    //cout << "in waitforevent2" << endl;
    al_wait_for_event(event_queue, &ev);    // doesn't execute, seg faults
    //cout << "in waitforevent3" << endl;
//cout << "Process event...\n";
